...
CREATE TABLE IF NOT EXISTS mail (
  ...
  text_encoding VARCHAR NOT NULL DEFAULT 'JSON_STRING'
);
CREATE TABLE IF NOT EXISTS mail_delivery (
  mail_id BIGINT NOT NULL REFERENCES mail(id),
  recipient_trip VARCHAR NOT NULL,
  attempt_id VARCHAR NOT NULL,
  state VARCHAR NOT NULL CHECK (state IN ('PENDING', 'ATTEMPTING', 'ACCEPTED', 'UNKNOWN')),
...
CREATE TABLE IF NOT EXISTS messages (
  ...
  created_on BIGINT NOT NULL, channel VARCHAR,
  visibility VARCHAR DEFAULT 'PUBLIC' CHECK (visibility IN ('PUBLIC', 'WHISPER'))
);
...
CREATE TABLE IF NOT EXISTS trips (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  type VARCHAR NOT NULL CONSTRAINT trips_type_check CHECK (type IN ('ADMIN', 'MODERATOR', 'TRUSTED', 'USER', 'REGULAR', 'PEST')),
