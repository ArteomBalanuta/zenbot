...
func TestRecentPublicRoomMessagesFiltersBoundsAndOrdersRealSQLite(t *testing.T) {
	db := sqlitefixture.Open(t, "agent-context")
...
func TestRecentPublicRoomMessagesRejectsInvalidArguments(t *testing.T) {
	...
	db := sqlitefixture.Open(t, "agent-context-invalid")
...
func TestRecentPublicRoomMessagesUsesExactParameterizedRoom(t *testing.T) {
	db := sqlitefixture.Open(t, "agent-context-room-scope")
