...
func TestAgentToolEvidenceRepositoryRealSQLiteIsolatesBoundsOrdersAndExpires(t *testing.T) {
	db := sqlitefixture.Open(t, "agent-tool-memory")
...
func TestAgentToolEvidenceRepositoryRejectsInvalidAndCancelled(t *testing.T) {
	...
	db := sqlitefixture.Open(t, "agent-tool-memory-invalid")
